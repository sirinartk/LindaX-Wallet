...
Template['elements_balance'].helpers({
  ...
  convertedBalance: function() {
    ...
    if (LXTools.getUnit() === 'noether') return 'infinite';
    ...
    if (balance) {
      if (
        ...
        return LXTools.formatBalance(balance, '0,0.00');
      else if (LXTools.getUnit() === 'LindaX')
        return LXTools.formatBalance(
          balance,
          this.showAllDecimals ? '0,0.00[0000000000000000]' : '0,0.00'
        );
      else if (LXTools.getUnit() === 'finney')
        return LXTools.formatBalance(
          balance,
          this.showAllDecimals ? '0,0.00[00000000000000]' : '0,0.00'
        );
      else return LXTools.formatBalance(balance, '0,0.00[000000]');
    }
  },
  /**
