...
!macro ENVFUNC un
  Function ${un}setenv
    ...
    StrCpy $NODEDATADIR "$APPDATA\LindaX"
...
Section Mist MIST_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "Glinx incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\Glinx\unpacked\glinx.exe" "" "" "LindaX" 30303 "" "" ""
    #SimpleFC::AdvAddRule "Glinx outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\Glinx\unpacked\glinx.exe" "" "" "LindaX" "" 30303 "" ""
    #SimpleFC::AdvAddRule "Glinx UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\Glinx\unpacked\glinx.exe" "" "" "LindaX" "" 30303 "" ""
...
Section "uninstall"
    ...
    #SimpleFC::AdvRemoveRule "Glinx incoming peers (TCP:30303)"
    #SimpleFC::AdvRemoveRule "Glinx outgoing peers (TCP:30303)"
    #SimpleFC::AdvRemoveRule "Glinx UDP discovery (UDP:30303)"
